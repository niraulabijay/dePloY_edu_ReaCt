...
export default function Classcontent() {
	...
	console.log(params);
	const getUrl = "https://noname.dotnep.com/api/overview/" + params.classSlug;
	console.log(getUrl);
										...
										<Route exact path={path}>
											<React.Fragment>
												...
												<p>
													...
													neque cum! orem Lorem ipsum dolor sit amet,
													consectetur tempora saepe ut sint distinctio totam
													laborum quo minima magnam quidem, doloremque, saepe ut
													sint distinctio totam laborum quo minima magnam
													quidem, doloremque, culpa facilis! Lorem ipsum dolor
													sit amet, consectetur adipisicing elit. Sequi
													perferendis veniam, possimus distinctio illo iure,
													amet sed earum unde quae voluptatum vel harum porro
													molestiae natus nam vitae neque cum! orem Lorem ipsum
													dolor sit amet, consectetur adipisicing elit. Quos,
													accusamus rerum tempora porro adipisci eveniet quia
													molestias ad, facilis tenetur dolor, ullam iure
