                ...
                <div className="container h-100">
                    <div className="row h-100 justify-content-center align-items-center">
                        <div className="col-md-5">
                            <img
                                src={require("../../pages/images/syllabus.jpg")}
                                alt=""
                                className="img-fluid"
                            />
                        </div>
                        <div className="col-md-7">
                            <div className="feature-container">
                                ...
                                <div className="description">
                                    ...
                                    adipisicing elit. Ex reiciendis, incidunt
                                    quos voluptatem mollitia et iusto delectus
                                    distinctio placeat voluptatibus repudiandae
                                    esse, vel magnam, quis quaerat aperiam totam
                                    eaque. Corporis.
                                </div>
                ...
                <div className="container h-100">
                    <div className="row h-100 justify-content-center align-items-center">
                        ...
                        <div className="col-md-5 order0">
                            <img
                                src={require("../../pages/images/analysis.jpg")}
                                alt=""
                                className="img-fluid"
                            />
                        </div>
            ...
            <div className="question-feature">
                <div className="container h-100">
                    <div className="row h-100 justify-content-center align-items-center">
                        <div className="col-md-5">
                            <img
                                src={require("../../pages/images/question.jpg")}
                                alt=""
                                className="img-fluid"
                            />
                        </div>
