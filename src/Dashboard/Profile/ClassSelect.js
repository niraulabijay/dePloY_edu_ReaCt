	...
	return (
		<React.Fragment>
			...
			<div className="setting-container">
				<div className="row">
					<div className="col-6 color-section"></div>
					<div className="col-6 nocolor-section"></div>
				</div>
					...
					<div className="row">
							...
							<div className="class">
								...
								<ul>
									{classResponse.map((myClass, index) => (
										<li
											key={index}
											onClick={() => handleClassSubmit(myClass.id)}
										>
											{" "}
											{myClass.name}{" "}
										</li>
						...
						<div className="col-6">
							<div className="preparation">
								<h3>Enroll in Preparation:</h3>
								<ul>
									{PreparationResponse.map((myPreparation, index) => (
										<li
											key={index}
											onClick={() => handleClassSubmit(myPreparation.id)}
										>
											{" "}
											{myPreparation.name}
										</li>
